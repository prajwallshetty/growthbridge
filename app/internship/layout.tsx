          ...
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="px-5 py-2.5 rounded-xl bg-[#111111] text-white text-[12.5px] font-bold tracking-tight hover:bg-[#F4C542] hover:text-[#111111] transition-all duration-250 flex items-center gap-1.5 shadow-sm"
              >
                <span>Apply Now</span>
